...
<head>
	...
	<link rel="icon" type="image/png" href="{{ asset('penjualan/favicon.ico') }}"/>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">Laundry <sup>APP</sup></div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy;<script>new Date().getFullYear()>2013&&document.write(+new Date().getFullYear());</script>, Fahmi Nuradi & Anisah Nurul Azhar.</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
